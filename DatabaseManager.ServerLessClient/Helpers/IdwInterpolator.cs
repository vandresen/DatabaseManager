...
namespace DatabaseManager.ServerLessClient.Helpers
{
    ...
    public class IdwInterpolator
    {
        ...
        private readonly KdTree<double, SurfacePoint> _tree;
        ...
        public IdwInterpolator(int dimensions, double power, int numberOfNeighbours)
        {
            ...
            _tree = new KdTree<double, SurfacePoint>(dimensions, new DoubleMath());
        }
        ...
        public void AddPoint(double value, params double[] coordinates)
        {
            ...
            var point = new SurfacePoint(value, coordinates);

            _tree.Add(coordinates, point);
        }

        public void AddPoint(SurfacePoint point)
        {
        ...
        public void AddPointRange(IEnumerable<SurfacePoint> points)
        {
            if (points == null)
        ...
        private double CalculateWeightedAverage(IEnumerable<SurfacePoint> points, double[] target)
        {
            var nominator = 0.0;
            var denominator = 0.0;
