    ...
    static class PredictionMethods
    {
        ...
        public static PredictionResult PredictFormationOrder(PredictionRuleSetup qcSetup, IDatabaseAccess dp, IIndexAccess idxdata)
        {
            ...
            if (_ageLookupCache == null)
            {
                ...
                {
                    var indexes = Task.Run(() => idxdata.GetIndexes(qcSetup.DataConnector, qcSetup.Project, "MarkerWell", "", "", "Unknown"))
        ...
        public static PredictionResult PredictDominantLithology(PredictionRuleSetup qcSetup, DapperDataAccess dp, IIndexAccess idxdata)
        {
            ...
            var indexes = idxdata.GetIndexes(qcSetup.DataConnector, qcSetup.Project, dataType, "", dataKey, "").GetAwaiter().GetResult();
