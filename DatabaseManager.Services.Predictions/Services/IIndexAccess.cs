...
namespace DatabaseManager.Services.Predictions.Services
{
    ...
    {
        Task<List<IndexDto>> GetIndexes(string dataSource, string project, string dataType, string dataName, string dataKey,string storageConnection);
        ...
        Task<ResponseDto> GetNeighbors(int id, string dataSource, string failRule, string path, string project);
